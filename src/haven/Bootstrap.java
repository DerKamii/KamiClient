...
public class Bootstrap implements UI.Receiver, UI.Runner {
    ...
    public static byte[] gettoken2(String user, String confname) {
	return(getprefb("savedtoken-" + mangleuser(user), confname, null, false));
    }

    public static void rottokens2(String user, String confname, boolean creat, boolean rm) {
    ...
    public static void settoken2(String user, String confname, byte[] token) {
	if(user == null)
	    return;
	String prefnm = user;
